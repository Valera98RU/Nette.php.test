...
class HomepagePresenter extends BasePresenter
 {
    ...
    protected function startup()
    {
        ...
        if(!$this->getUser()->isAllowed(AuthorizationFactory::HOMEPAGE,AuthorizationFactory::VIEW)){
    ...
    /**
     * Перерисовывает snippets после ajax запроса
     *
     */
	...
	public function actionDelete(int $id):void{
	    if($this->user->isAllowed(AuthorizationFactory::HOMEPAGE,AuthorizationFactory::DELETE)) {
