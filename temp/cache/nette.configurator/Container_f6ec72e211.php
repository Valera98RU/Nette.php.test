<?php
// source: W:\domains\nette.test.php/config/common.neon
// source: W:\domains\nette.test.php/config/local.neon
// source: array
...
class Container_f6ec72e211 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'App\Presenters\BasePresenter' => [2 => ['application.2', 'application.5']],
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'W:\domains\nette.test.php/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('W:\domains\nette.test.php/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('W:\domains\nette.test.php/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_f6ec72e211
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1; dbname=nette_test', 'root', 'root', ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_f6ec72e211 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('W:\domains\nette.test.php/temp/cache/latte');
